                    ...
                    <div style={{ marginTop: '1rem', display: 'flex', gap: '1.5rem', justifyContent: 'center', alignItems: 'center' }}>
                        {settings.instagram && (
                            <a href={settings.instagram} target="_blank" rel="noopener noreferrer"
                                style={{ color: '#E4405F', fontSize: '1.75rem', transition: 'all 0.3s', display: 'flex' }}
                                title="Instagram">
                        ...
                        {settings.whatsapp && (
                            <a href={settings.whatsapp} target="_blank" rel="noopener noreferrer"
                                style={{ color: '#25D366', fontSize: '1.75rem', transition: 'all 0.3s', display: 'flex' }}
                                title="WhatsApp">
                                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        {settings.linkedin && (
                            <a href={settings.linkedin} target="_blank" rel="noopener noreferrer"
                                style={{ color: '#0077B5', fontSize: '1.75rem', transition: 'all 0.3s', display: 'flex' }}
                                title="LinkedIn">
                                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
